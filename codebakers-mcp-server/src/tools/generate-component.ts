...
export async function generateComponent(args: ComponentArgs): Promise<string> {
...
function generateListComponent(name: string, entity: string): string {
...
function generateDetailComponent(name: string, entity: string): string {
  return `'use client';
...
function generateFormComponent(name: string, entity: string): string {
  return `'use client';

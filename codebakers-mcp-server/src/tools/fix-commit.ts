...
export async function fixCommit(args: { auto_fix?: boolean }): Promise<string> {
 ...
 * Analyze last commit
 */
async function analyzeLastCommit(cwd: string): Promise<CommitAnalysis> {
 ...
 * Generate fix report
 */
function generateFixReport(analysis: CommitAnalysis, autoFix: boolean): string {

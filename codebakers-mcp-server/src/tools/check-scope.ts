...
interface ScopeCheckResult {
  ...
  matched_state_changes: string[];
  confidence: 'high' | 'medium' | 'low' | 'none';
  recommendation: string;
  spec_amendment_required: boolean;
}
 ...
 */
function checkFeatureAgainstSpec(
  description: string,
  entities: string[],
  stateChanges: string[]
): ScopeCheckResult {
  ...
  const matchedStateChanges: string[] = [];
  ...
  let specAmendmentRequired: boolean;

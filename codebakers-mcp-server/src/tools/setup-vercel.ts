...
export async function setupVercel(args: VercelSetupArgs = {}): Promise<string> {
...
async function linkProject(cwd: string, projectName: string | undefined, productionBranch: string): Promise<string> {
  try {
...
async function getProjectInfo(projectId: string, teamId: string): Promise<any> {
  try {
...
async function startOAuthFlow(): Promise<VercelCredentials> {
...
async function exchangeCodeForToken(code: string): Promise<VercelCredentials> {
...
async function saveCredentials(cwd: string, credentials: VercelCredentials): Promise<void> {

 ...
 */
function inferGate0(description, projectName) {
 ...
 */
function inferGate1(description, gate0) {
    const entities = [];
    const lowerDesc = description.toLowerCase();
 ...
 */
function inferGate4(description) {
    const dependencies = [];
    const lowerDesc = description.toLowerCase();
 ...
 */
function inferGate5(description) {
    const integrations = [];
    const lowerDesc = description.toLowerCase();
    if (lowerDesc.includes('email')) {
        integrations.push({
 ...
 */
function generateSpecDocument(gate0, gate1, gate2, gate3, gate4, gate5) {
 ...
 */
function generateBuildState(gate0) {
    let doc = `# Build State\n\n`;
 ...
 * Generate summary
 */
function generateSpecSummary(gate0, gate1, gate2, gate3, gate4, gate5) {
